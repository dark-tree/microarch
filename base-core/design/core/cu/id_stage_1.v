module id_stage_1
  ...
  wire bus_a_read = alu_bus_a_read | (instruction[23:20] == 4'b0100) | (instruction[23:20] == 4'b0011) | (instruction[23:20] == 4'b0111);
  wire bus_b_read = alu_bus_b_read | (instruction[23:20] == 4'b0100) | (instruction[23:21] == 3'b001);
